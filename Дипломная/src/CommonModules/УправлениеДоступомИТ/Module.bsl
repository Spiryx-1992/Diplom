...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// + добаление новых профилей 06.07.26
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "d4978b2e-b18d-433d-b84f-409dfdafcc33";
	...
	ОписаниеПрофиля.Идентификатор = "8562ada4-74ad-4f5a-a4cd-7d9591c6b382";
	...
	ОписаниеПрофиля.Идентификатор = "e1f10fab-19eb-45c0-9680-becf4b340b95";
	...
	ОписаниеПрофиля.Идентификатор = "1e389844-473a-420d-b454-64acd85777d9";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Кадровик-Расчетчик'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеВариантовОтчетов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РедактированиеДанныхЗарплаты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_УправлениеПлановымиОтпусками");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
